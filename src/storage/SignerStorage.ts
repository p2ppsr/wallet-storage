...
export class SignerStorage implements sdk.SignerStorage {
    ...
    stores: sdk.SignerStorageAuth[] = []
    _authId: sdk.AuthId
    _services?: sdk.WalletServices
    _userIdentityKeyToId: Record<string, number> = {}

    constructor(identityKey: string, active: sdk.SignerStorageAuth, backups?: sdk.SignerStorageAuth[]) {
        this.stores = [ active ]
    ...
    getActive(): sdk.SignerStorageAuth { return this.stores[0] }
